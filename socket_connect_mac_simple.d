...
/* AF_INET{6} are unknown to dtrace, so replace with numbers from /usr/include/sys/socket.h */
...
{ 
	...
	printf("%-6d %-20s %-8d %-21s %-21s %-8d %s\n", 
		pid, execname, this->f, self->s_addr, self->d_addr, this->delta, this->errstr); 
